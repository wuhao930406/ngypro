export default {
  ...
  'app.register-result.msg': 'Account：got new password at {email}',
  'app.register.submit': 'confirm',
  'app.register-result.activation-email':
    'The new password email has been sent to your email address and is valid for 24 hours.',
