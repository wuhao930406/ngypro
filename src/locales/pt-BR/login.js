export default {
  ...
  'app.register-result.msg': 'Conta：Recuperar senha de SUCESSO em {email}',
  'app.register.submit': 'A confirmação',
  'app.register-result.activation-email':
    'A Nova senha email de ativação foi enviado para o seu email e é válido por 24 horas. Por favor entre no seu email e clique no link de ativação da conta.',
