...
export default {
  ...
  effects: {
    *forgotpage({ payload }, { call, put }) {//datalist
      yield put({
        type: 'updateState',
        payload: { forgotpage: payload.show ? payload.show : false }
      })
      return true
    },
    ...
    *registerpage({ payload }, { call, put }) {//datalist
      yield put({
        type: 'updateState',
        payload: { registerpage: payload.show ? true : false }
      })
      return true
    },
  },
