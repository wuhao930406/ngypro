...
class RepairList extends React.Component {
  ...
  render() {
    let { postData, postUrl, fv, fields, iftype, curitem, expandedRowKeyes } = this.state,
      { repairqueryList, repairTypeList, faultTypeList, chart, rslgetRepairDetail, dataList, deviceTypequeryTreeList, KLqueryKnowledgeByFaultId } = this.props.repair;
        ...
        <Card title='维修单列表' extra={
          ...
          <Table size="middle"
            ...
            pagination={{
              ...
              total: repairqueryList.total ? parseInt(repairqueryList.total) : 1,
              onChange: pageChange,
            }}
            rowKey='id'
            columns={columns}
