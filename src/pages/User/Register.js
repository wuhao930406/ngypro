...
class Register extends Component {
        ...
        if (key.val == "") {
          ...
          this.setNewState("submit", values, () => {
            ...
            Modal.info({
              ...
              content: (
                <div>
                  <p>{`您的工单号为：${this.props.regist.fakeRegister.data.applyNo}，工单号可用来查询审核进度`}</p>
                </div>
              ),
              onOk() { },
            });
  ...
  render() {
    ...
    const { code, getApplyInfo, getApplyInfoList, registerpage } = regist;
        ...
        <Tabs
          ...
          <TabPane
            ...
            <Scrollbars autoHide style={{
              maxWidth: "100%", height: 500, overflowX: "hidden"
            }}>
                ...
                <FormItem label="公司编号">
                  {
                    getFieldDecorator('companyCode', {
                      ...
                      <Input size="large" placeholder='公司编号开头为四个大写字母' />
                    )}
                </FormItem>
                <FormItem label="公司地址">
          ...
          <TabPane
            key="2"
            tab={<span ><Icon type="align-left" />申请进度</span>}>
            <Scrollbars autoHide style={{ maxWidth: "100%", height: 560,  overflowX: "hidden"}}>
              <p style={{color:"#fff"}}>请输入单号进行查询</p>
              <Input.Search placeholder="请输入单号进行查询！" value={searchval} 
              onChange={(e) => {
                ...
                getApplyInfo && <Card style={{ margin: "0px 0px 24px 0px" }} title="申请信息" extra={
                  ...
                  <div className={styles.indep}>
                    ...
                    <div style={{ display: "block" }}>
                      <span style={{ width: 100, textAlign: "right", paddingRight: 10, display: "block", marginBottom: 12 }}>审核记录:</span>
                      <Table size="middle"
                        ...
                        columns={[
                          {
                            ...
                            dataIndex: 'status',
                            key: 'status',
                            render: (text) => (<span>{text == "1" ? "已审核" : "待审批"}</span>)
                          },
                          {
                            title: '是否通过',
                            dataIndex: 'isPass',
              ...
              {
                !getApplyInfo && <Table size="middle"   ></Table>
              }
            </Scrollbars>
          </TabPane>
