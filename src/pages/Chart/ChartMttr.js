...
@connect(({ chart, loading }) => ({
  chart,
  submitting: loading.effects['chart/queryMTTR'],
}))
class ChartMttr extends Component {
  constructor(props) {
    super(props);
    this.state = {
      postData: {
  ...
  getOption() {
    let allData = this.props.chart.queryMTTR;
    let res = {}
  ...
  render() {
    const { postData } = this.state,
      { queryMTTR, companyList, departmentList, shopList, shiftList } = this.props.chart;
