      ...
      <Layout>
        ...
        >
          ...
          <Content className={styles.content} style={contentStyle}>
            ...
            {this.updateTree(routes).map((item, index) => {
              return (<LiveRoute path={item.path} exact={true} key={index} alwaysLive={true} component={item.component} />)
            })} */}
