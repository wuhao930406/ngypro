...
const copyright = (
  <div style={{display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center"}}>
      <div style={{display:"block"}}>
        <span style={{color:"rgba(255,255,255,0.6)"}}>Copyright 
        <Icon type="copyright" /> 2017 江苏南高智能装备创新中心有限公司 版权所有</span><br/> 
        <span style={{color:"rgba(255,255,255,0.6)"}}>备案序号 : 苏IPC备 18015471 号</span>
      </div>
      <div>
        <img style={{height:60,marginTop:12,borderRadius:4}} src="./images/tts.png" alt=""/>
        <p style={{color:"#fff"}}>扫码分享</p>
      </div>
  </div>
...
class UserLayout extends Component {
  ...
  componentDidMount() {
    this.hm = document.createElement("script");
    this.hm.src = "https://hm.baidu.com/hm.js?6715cb8cdbb2bcb2080df7c64762e3a9";
    var s = document.getElementsByTagName("script")[0];
    s.parentNode.insertBefore(this.hm, s);
      ...
      <DocumentTitle title={getPageTitle(pathname, breadcrumbNameMap)}>
        <div className={styles.container}>
          ...
          <div className={styles.timetable}>
             <a href="http://172.21.3.4/ng/" style={{ fontSize: 18 }}>
              <Icon type='home'  style={{ marginRight: 10 }}></Icon>   
              首页
             </a>
              
              <p style={{paddingTop:12}}>
                <Icon type="clock-circle" style={{ float: "left", marginTop: 4, marginRight: 10 }} />
                {
                  time.map((item, i) => {
