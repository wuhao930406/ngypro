...
export async function sendCode(params){
  return request(`/ngy/sysUser/sendVerificationCode`,{
    method: 'POST',
    body: params
  });
}
...
export async function compairCode(params){
  return request(`/ngy/sysUser/repareVerificationCode`,{
    method: 'POST',
    body: params
  });
}
...
export async function updatePassword(params){
  return request(`/ngy/sysUser/reparePassword`,{
    method: 'POST',
    body: params,
  });
}
...
export async function getApplyInfo(params){
  return request(`/ngy/sysCompanyApply/queryByApplyNo`,{
    method: 'POST',
    body: params,
  });
}
...
export async function updateApply(params){
  return request(`/ngy/sysCompanyApply/save`,{
    method: 'POST',
    body: params,
  });
}
...
export async function getMenu(params){
  return request(`/ngy/sysPermission/queryMenu`, {
    method: 'POST',
  });
}
/*---------------main.获取菜单-------------------*/
